        ...
        match self.comp_name.as_str() {
            ...
            "ProductItem" => {
                match chunk_id {
                    0 => {
                        if (mask & (1 << 22)) != 0 {
                            let v = ((self.i32_mem[4] - self.i32_mem[5])) as i32;
                            if self.i32_mem[6] != v {
                                self.i32_mem[6] = v;
                                mask |= 1 << 19;
                                mask |= 1 << 16;
                        ...
                        if (mask & (1 << 19)) != 0 {
                            let v = (if self.i32_mem[6] <= self.i32_mem[7] { 1 } else { 0 }) as i32;
                            if self.i32_mem[8] != v {
                                self.i32_mem[8] = v;
                                self.flags_r[0] |= 1 << 18;
                                self.l2_r[0] |= 1 << 31;
                        ...
                        if (mask & (1 << 16)) != 0 {
                            let v = (if self.i32_mem[6] > self.i32_mem[9] { 1 } else { 0 }) as i32;
                        ...
                        if (mask & (1 << 14)) != 0 {
                            let v = (if self.i32_mem[6] <= self.i32_mem[11] { 1 } else { 0 }) as i32;
                        ...
                        if (mask & (1 << 13)) != 0 {
                            let v = (if self.i32_mem[10] != 0 && self.i32_mem[12] != 0 { 1 } else { 0 }) as i32;
                        ...
                        if (mask & (1 << 9)) != 0 {
                            let v = (if self.i32_mem[5] < self.i32_mem[4] { 1 } else { 0 }) as i32;
                        ...
                        if (mask & (1 << 6)) != 0 {
                            let v = (if self.i32_mem[14] != 0 { self.i32_mem[15] } else { self.i32_mem[16] }) as i32;
                        ...
                        if (mask & (1 << 5)) != 0 {
                            let v = ((self.i32_mem[6] - self.i32_mem[17])) as i32;
                        ...
                        if (mask & (1 << 3)) != 0 {
                            let v = (if self.i32_mem[18] <= self.i32_mem[19] { 1 } else { 0 }) as i32;
                            if self.i32_mem[20] != v {
                                self.i32_mem[20] = v;
                            }
                        }
                        if (mask & (1 << 1)) != 0 {
                            let v = ((self.i32_mem[5] + self.i32_mem[17])) as i32;
            ...
            "Cart" => {
                match chunk_id {
                    ...
                    1 => {
                        ...
                        if (mask & (1 << 26)) != 0 {
                            let v = ((self.i32_mem[25] * self.i32_mem[26])) as i32;
                        ...
                        if (mask & (1 << 25)) != 0 {
                            let v = ((self.i32_mem[2] + self.i32_mem[28])) as i32;
                            if self.i32_mem[29] != v {
                                self.i32_mem[29] = v;
                            }
                        }
                    },
